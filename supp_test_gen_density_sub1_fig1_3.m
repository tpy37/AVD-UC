...
fig= gcf;
set(gca,'layer','top')
saveas(gcf,'results\supp_figure\sub_density1_fig1.png')
%% Figure 2
figure('units','normalized','outerposition',[0 0 1 1])
...
saveas(gcf,'results\supp_figure\sub_density1_fig2.png')
...
fig= gcf;
set(gca,'layer','top')
saveas(gcf,'results\supp_figure\sub_density1_fig3.png')
